 ...
 */
public class WorkTodayFragment extends BaseFragment {
    ...
    protected int getLayoutResource() {
        return R.layout.fragment_list_today;
    }

    @Override
    protected void initVariables(Bundle saveInstanceState, View rootView) {
        recyclerView = (RecyclerView) rootView.findViewById(R.id.rcvListToday);
    }
